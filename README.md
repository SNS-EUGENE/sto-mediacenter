...
|----|----------|------|------|----------|
| 1 | 대형 스튜디오 | 대형 | 다목적 대형 공간 | 최대 30명 |
| 2 | 1인 스튜디오 A | 1인 A | 개인 크리에이터용 소형 스튜디오 | 최대 2명 |
| 3 | 1인 스튜디오 B | 1인 B | 개인 크리에이터용 소형 스튜디오 | 최대 2명 |
...
| 구분 | 상태 | 비고 |
|------|------|------|
| UI/프론트엔드 | 80% | 모든 페이지 UI 완료, 디자인 개선 완료 |
...
### 최근 작업 내역 (2025-01-13)
- 실시간 현황 페이지 UI 개선 (타임라인, 날짜 네비게이션)
- 사이드바 로고 섹션 디자인 개선
- 스튜디오 명칭 통일 (1인 스튜디오 A/B)
- 캘린더 예약 목록 글라스 테마 적용
- 통계 페이지 캘린더 UI 개선
- 사이드바 접기 기능 일시 비활성화 (애니메이션 버그)
